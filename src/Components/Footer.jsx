...
export default function Footer() {
    return (
        <footer className="text-center lg:text-left bg-gray-800 text-gray-100 mt-12">
          ...
          ">
                    ...
                    <div className="">
                        ...
                        <p className="mb-4">
                            <a href="#!" className="text-gray-100">Vite React</a>
                        </p>
                        <p className="mb-4">
                            <a href="#!" className="text-gray-100">Tailwind</a>
                        </p>
                        <p className="mb-4">
                            <a href="#!" className="text-gray-100">Hero</a>
                        </p>
                        <p>
                            <a href="#!" className="text-gray-100">Material</a>
                        </p>
                    </div>
                    <div className="">
                        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
                        ...
                        <p className="mb-4">
                            <a href="#!" className="text-gray-100">Programming</a>
                        </p>
                        <p className="mb-4">
                            <a href="#!" className="text-gray-100">Tools</a>
                        </p>
                        <p className="mb-4">
                            <a href="#!" className="text-gray-100">Experience</a>
                        </p>
                        <p>
                            <a href="#!" className="text-gray-100">Kontak</a>
                        </p>
                    </div>
                    <div className="">
                        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
